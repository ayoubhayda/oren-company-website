...
import { ArrowLeft, ArrowRight, Calendar, Users, Building, Target, Zap, Quote, Image as ImageIcon, Layers, Star, Share2, ChevronLeft, ChevronRight, Github, MessageSquare } from "lucide-react"
import Link from "next/link"
import Image from "next/image"
import { useLanguage } from "@/components/language-provider"
import JsonToHtml from "@/components/general/JsonToHtml"

// Use TipTap's JSONContent type
                  ...
                  <div className="prose prose-xl max-w-none">
                    {(() => {
                      ...
                      if (typeof currentChallenge === 'string') {
                        return <div dangerouslySetInnerHTML={{ __html: currentChallenge }} />;
                      }
                ...
                {project.testimonial && (
                  <Card className="bg-primary/5 border-primary/20">
                    <CardContent className="p-6">
                      ...
                      <p className="text-foreground mb-4 italic">&ldquo;{t("project.testimonialQuote")}&rdquo;</p>
                      <div>
