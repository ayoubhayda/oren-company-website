...
import { TrendingUp, Search, Share2, BarChart, Target, Users, Zap, Database, Globe, Wrench, Sparkles, Mail, Smartphone, ArrowRight, Play } from "lucide-react"
        ...
        <section className="py-20 lg:py-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto bg-primary text-primary-foreground rounded-2xl p-12 text-center space-y-6">
              <h2 className="text-3xl sm:text-4xl font-bold">{t("services.digital-marketing.cta.title")}</h2>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                <Button size="lg" variant="secondary" asChild className="dark:bg-white dark:text-black dark:hover:bg-white/85 ">
                  <Link href="/contact">{t("services.digital-marketing.cta.button.primary")}</Link>
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                ...
                >
                  <Link href="/portfolio">{t("services.digital-marketing.cta.button.secondary")}</Link>
              </Button>
              </div>
            </div>
          </div>
