...
import { Code, Smartphone, Zap, Shield, Search, Globe, Wrench, Sparkles, ArrowRight, Play, MessageSquare } from "lucide-react"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.h2
                ...
                transition={{ duration: 0.6, delay: 0.3 }}
              >
                {t("services.web-dev.features.title")}
              </motion.h2>
              <motion.p
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.h2
                ...
                transition={{ duration: 0.6, delay: 0.3 }}
              >
                {t("services.web-dev.technologies.title")}
              </motion.h2>
              <motion.p
                className="text-lg text-muted-foreground"
                initial={{ opacity: 0, y: 20 }}
                ...
                transition={{ duration: 0.6, delay: 0.4 }}
              >
                {t("services.web-dev.technologies.subtitle")}
              </motion.p>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.h2
                ...
                transition={{ duration: 0.6, delay: 0.3 }}
              >
                {t("services.web-dev.process.title")}
              </motion.h2>
              <motion.p
                className="text-lg text-muted-foreground"
                initial={{ opacity: 0, y: 20 }}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.p
                ...
                transition={{ duration: 0.6, delay: 0.4 }}
              >
                {t("services.web-dev.faq.subtitle")}
              </motion.p>
            </motion.div>
            ...
            >
              <Accordion type="single" collapsible className="space-y-4">
                {[
                  {
                    value: "item-1",
                    questionKey: "services.web-dev.faq.timeline.question",
                    answerKey: "services.web-dev.faq.timeline.answer"
                  },
                  {
                    value: "item-2",
                    questionKey: "services.web-dev.faq.cost.question",
                    answerKey: "services.web-dev.faq.cost.answer"
                  },
                  {
                    value: "item-3",
                    questionKey: "services.web-dev.faq.maintenance.question",
                    answerKey: "services.web-dev.faq.maintenance.answer"
                  },
                  {
                    value: "item-4",
                    questionKey: "services.web-dev.faq.mobile.question",
                    answerKey: "services.web-dev.faq.mobile.answer"
                  },
                  {
                    value: "item-5",
                    questionKey: "services.web-dev.faq.seo.question",
                    answerKey: "services.web-dev.faq.seo.answer"
                  }
                ].map((item, index) => (
                  <motion.div
                    key={item.value}
