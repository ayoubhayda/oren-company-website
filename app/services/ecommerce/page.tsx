...
import { ShoppingCart, CreditCard, Package, TrendingUp, Shield, Smartphone, Zap, Database, Globe, Wrench, Sparkles, ArrowRight, Play } from "lucide-react"
                ...
                <div className="pt-8 sm:pt-12 flex flex-wrap items-center justify-center gap-5 sm:gap-12 text-xs sm:text-sm text-muted-foreground">
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    ...
                    <span className="text-[10px] sm:text-sm">
                      {t("services.ecommerce.hero.stats.uptime")}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <span className="text-[10px] sm:text-sm">
                      {t("services.ecommerce.hero.stats.stores")}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-3">
                    <span className="text-lg sm:text-2xl font-bold text-foreground">
                    ...
                    <span className="text-[10px] sm:text-sm">
                      {t("services.ecommerce.hero.stats.compliant")}
                    </span>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 lg:py-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4">{t("services.ecommerce.features.title")}</h2>
              <p className="text-lg text-muted-foreground">{t("services.ecommerce.features.subtitle")}</p>
            </div>
        ...
        <section className="py-20 lg:py-32 bg-muted/30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4">{t("services.ecommerce.technologies.title")}</h2>
              <p className="text-lg text-muted-foreground">{t("services.ecommerce.technologies.subtitle")}</p>
            </div>
        ...
        <section className="py-20 lg:py-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4">{t("services.ecommerce.process.title")}</h2>
        ...
        <section className="py-20 lg:py-32 bg-muted/30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground">{t("services.ecommerce.faq.subtitle")}</p>
            </div>
              ...
              <Accordion type="single" collapsible className="space-y-4">
                <AccordionItem value="item-1" className="bg-card border border-border rounded-lg px-6">
                  <AccordionTrigger className="text-left hover:no-underline">
                    {t("services.ecommerce.faq.platforms.question")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                    {t("services.ecommerce.faq.platforms.answer")}
                  </AccordionContent>
                </AccordionItem>

                <AccordionItem value="item-2" className="bg-card border border-border rounded-lg px-6">
                  <AccordionTrigger className="text-left hover:no-underline">
                    {t("services.ecommerce.faq.payments.question")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                    {t("services.ecommerce.faq.payments.answer")}
                  </AccordionContent>
                </AccordionItem>

                <AccordionItem value="item-3" className="bg-card border border-border rounded-lg px-6">
                  <AccordionTrigger className="text-left hover:no-underline">
                    {t("services.ecommerce.faq.scaling.question")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                    {t("services.ecommerce.faq.scaling.answer")}
                  </AccordionContent>
                </AccordionItem>

                <AccordionItem value="item-4" className="bg-card border border-border rounded-lg px-6">
                  <AccordionTrigger className="text-left hover:no-underline">
                    {t("services.ecommerce.faq.seo.question")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                    {t("services.ecommerce.faq.seo.answer")}
                  </AccordionContent>
                </AccordionItem>

                <AccordionItem value="item-5" className="bg-card border border-border rounded-lg px-6">
                  <AccordionTrigger className="text-left hover:no-underline">
                    {t("services.ecommerce.faq.support.question")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                    {t("services.ecommerce.faq.support.answer")}
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
        ...
        <section className="py-20 lg:py-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto bg-primary text-primary-foreground rounded-2xl p-12 text-center space-y-6">
              <h2 className="text-3xl sm:text-4xl font-bold">{t("services.ecommerce.cta.title")}</h2>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                <Button size="lg" variant="secondary" asChild className="dark:bg-white dark:text-black dark:hover:bg-white/85 ">
                  <Link href="/contact">{t("services.ecommerce.cta.button.primary")}</Link>
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                ...
                >
                  <Link href="/portfolio">{t("services.ecommerce.cta.button.secondary")}</Link>
              </Button>
              </div>
            </div>
          </div>
